...
@pytest.fixture
def test_list_of_accounts(driver, perform_actions_with_wait, load_locators, load_locators_card):
...
@pytest.fixture
def test_list_of_accounts_negative(driver, perform_actions_with_wait, load_locators, load_locators_card):
    locators_data = load_locators   # Use it as a fixture, not a function
    locators_data_load = load_locators_card
    driver.implicitly_wait(20)
