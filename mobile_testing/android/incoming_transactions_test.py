...
@pytest.fixture
def test_incoming_transaction(driver, perform_actions_with_wait, load_locators):
...
@pytest.fixture
def test_incoming_transaction_negative(driver, perform_actions_with_wait, load_locators):
    locators_data = load_locators  # Use it as a fixture, not a function
    driver.implicitly_wait(20)
